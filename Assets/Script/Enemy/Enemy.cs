...
public class Enemy : MonoBehaviour {
    ...
    void Update()
    {
        ...
        //if (avoidObj == true) {
        Debug.DrawRay(rayOrigin[0].position, rayOrigin[0].forward * 10, Color.red);
        Debug.DrawRay(rayOrigin[1].position, rayOrigin[1].forward * 10, Color.red);
        Debug.DrawRay(rayOrigin[2].position, rayOrigin[2].forward * 10, Color.red);
        Debug.DrawRay(rayOrigin[3].position, rayOrigin[3].forward * 10, Color.red);
        if (Physics.Raycast(AIRay1, out wallHit, 10))
        {

            patrol = false;
            if (wallHit.collider.transform.root.position != transform.position && wallHit.transform.name == "TankPlayer")
            {
                Debug.Log("AIRay1:" + wallHit.transform.name);
        ...
        if (Physics.Raycast(AIRay1, out wallHit, 10) && Physics.Raycast(AIRay2, out wallHit, 10))
        {
            finalSpeed = -1;
        }
        else
        ...
        if (Physics.Raycast(AIRay2, out wallHit, 10))
        {
            ...
            if (wallHit.collider.transform.root.position != transform.position && wallHit.transform.name == "TankPlayer")
            {
                Debug.Log("AIRay2:" + wallHit.transform.name);
        ...
        if (Physics.Raycast(AIRay3, out wallHit, 10))
        {
            ...
            if (wallHit.collider.transform.root.position != transform.position && wallHit.transform.name == "TankPlayer")
            {
                Debug.Log("AIRay3:" + wallHit.transform.name);
                transform.Rotate(Vector3.up * 20 * Time.deltaTime);
            }
        }
        else patrol = true;

        if (Physics.Raycast(AIRay4, out wallHit, 10))
        {
            ...
            if (wallHit.collider.transform.root.position != transform.position && wallHit.transform.name == "TankPlayer")
            {
                Debug.Log("AIRay4:" + wallHit.transform.name);
                transform.Rotate(Vector3.up * -20 * Time.deltaTime);
            }
        }
        else patrol = true;
